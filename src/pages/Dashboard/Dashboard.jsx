            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 max-w-md w-full shadow-2xl">
                ...
                <div className="text-center">
                  ...
                  {/* El balance disponible ya viene con la comisión descontada,
                      así que aquí NO se vuelve a restar: hacerlo se la cobraba
                      al profesor dos veces. */}
                  <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-6">
                    <div className="flex justify-between items-baseline">
                      <span className="font-semibold text-white">Recibes</span>
                      <span className="text-2xl font-bold text-green-300">
                        {formatPrecio(montoRetiro)}
                      </span>
                    </div>
                    <p className="text-xs text-purple-300 mt-2 text-left">
                      La comisión de la plataforma ya está descontada de tu balance.
                    </p>
                  </div>

                  <p className="text-sm text-purple-200 mb-6 leading-relaxed">
                    Se enviará una solicitud de retiro. Un administrador la revisará
                    y realizará el pago a tu cuenta.
                  </p>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className={`flex-1 px-4 py-2.5 rounded-lg text-white font-semibold transition-colors ${loadingRetiro

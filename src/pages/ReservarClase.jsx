                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="relative">
                        {/* color-scheme:dark hace visible el icono nativo del
                            calendario sobre el fondo oscuro; showPicker abre el
                        ...
                        <input
                          ...
                          className="w-full px-6 py-4 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-purple-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm [color-scheme:dark] cursor-pointer"
                          required
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        {/* pointer-events-none: el icono es decorativo y no debe
                            interceptar los clics dirigidos al campo. */}
